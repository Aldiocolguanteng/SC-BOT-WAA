...
*✗⃝🎩 Total commands : 137*
*✗⃝🎩 Owner* : @${configs.ownerList[0].split('@')[0]}
*✗⃝🎩 Prefix* : Multi
*✗⃝🎩 Time* : ${moment().utcOffset('1000').format('YYYY-MM-DD HH:mm:ss')} WIB
...
const ingfo = `
*❒─────⎔✗⃝🌹 「 SEWA BOT 」⎔──❒*
*➪✗⃝🌹* _*SEWABOT 5K/MINGGU*_
*➪✗⃝🌹* _*SEWABOT 10K/BULAN*_
*➪✗⃝🌹* _*SEWABOT 15K/3BULAN*_
*➪✗⃝🌹* _*PERMANENT? LU TOLOLZ*_
*❒───⎔✗⃝🌹*

*❒─────⎔✗⃝🌹 「 PREMIUM 」⎔──❒*
*➪✗⃝🌹* _*PREMIUM 5K/MINGGU*_
*➪✗⃝🌹* _*PREMIUM 10K/BULAN*_
*➪✗⃝🌹* _*PREMIUM 15K/3BULAN*_
*➪✗⃝🌹* _*PERMANENT? LU TOLOLZ*_
*❒───⎔✗⃝🌹*

*❒─────⎔✗⃝🌹 「 SEWA & PREMIUM 」⎔──❒*
*➪✗⃝🌹* _*SEWABOT + PREMIUM 10K/MINGGU*_
*➪✗⃝🌹* _*SEWABOT + PREMIUM 20K/BULAN*_
*➪✗⃝🌹* _*SEWABOT + PREMIUM 25K/3BULAN*_
*➪✗⃝🌹* _*PERMANENT? LU TOLOLZ*_
*❒───⎔✗⃝🌹*

*❒─────⎔✗⃝🔥 「 JADIBOT 」⎔──❒*
*➪✗⃝🔥* _*JADI BOT 5K/MINGGU*_
*➪✗⃝🔥* _*JADI BOT 10K/BULAN*_
*➪✗⃝🔥* _*JADI BOT 15K/3BULAN*_
*➪✗⃝🔥* _*PERMANENT? LU TOLOLZ*_
*➪✗⃝🔥* _*SC BOT TANYA OWNER*_
*❒───⎔✗⃝🔥*

*❒─────⎔✗⃝💌 「 SOSMED OWNER 」⎔──❒*
*➪✗⃝💌* _*Jika Minat Pc Owner*_
*➪✗⃝💌* _*wa.me/6287705048235*_
*➪✗⃝💌* _*IG: @aldiocol01*_
*➪✗⃝💌* _*YT: BangXyon DJ*_
*❒───⎔✗⃝💌*
`
...
const mess = {
			 ...
			 botAdmin: '```This Command Can Only Be Used If The Bot Is An Admin Group```',
